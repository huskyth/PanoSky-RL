...
class MultiDiscrete(gym.Space):
    ...
    - It is parametrized by passing an array of arrays containing [min, max] for each discrete action space where the discrete action space can take any integers trainer `min` to `max` (both inclusive)
